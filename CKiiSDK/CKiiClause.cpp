...
kiicloud::CKiiClause::CKiiClause(const CKiiClause& rhs)
:clause(rhs.clause)
{
}

kiicloud::CKiiClause::CKiiClause(CKiiClause&& rhs)
:clause(rhs.clause)
{
    rhs.clause = picojson::object();
}
...
kiicloud::CKiiClause kiicloud::CKiiClause::operator or (const CKiiClause& rhs) const
{
    picojson::object cls;
    picojson::array jsarray;
    jsarray.push_back(picojson::value(this->clause));
    jsarray.push_back(picojson::value(rhs.clause));
...
kiicloud::CKiiClause kiicloud::CKiiClause::operator and (const CKiiClause& rhs) const
{
    picojson::object cls;
    picojson::array jsarray;
    jsarray.push_back(picojson::value(this->clause));
